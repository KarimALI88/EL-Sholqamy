...
const MainHeader = ({title = "headerHomeTitle"}) => {
  ...
  return (
    <div className='min-h-[100vh]' style={{backgroundImage: `linear-gradient(rgba(1,1,1,0.7), rgba(1,1,1,0.6)), url(${headerBg})`, backgroundPosition:"center", backgroundSize:"100% 100%", backgroundRepeat:"no-repeat"}}>
      <TopNavBar />
      {/*content of header */}
