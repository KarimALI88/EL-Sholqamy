...
const Home = () => {
  ...
  return (
    <div className='home-page'>
      ...
      <AboutUsPart />
      <div className='h-96 w-full text-center flex flex-col justify-center items-center my-5' style={{backgroundImage: `linear-gradient(rgba(17, 17, 17, 0.75), rgba(17, 17, 17, 0.75)), url(${lambBg})`, backgroundPosition:"center", backgroundSize:"cover", backgroundRepeat:"no-repeat", backgroundAttachment: "fixed"}}>
